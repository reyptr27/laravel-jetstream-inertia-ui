...
export const IdIcon = defineComponent({
  name: "IdIcon",
  setup() {
    return () => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        <rect x="1" y="1" width="18" height="18" rx="5" stroke="currentColor" stroke-width="1" fill="none" />
        <text x="50%" y="50%" dy=".3em" text-anchor="middle" font-size="10" font-weight="700" fill="currentColor" font-family="Inter, sans-serif">
          Id
        </text>
      </svg>
    );
...
export const EnIcon = defineComponent({
  name: "EnIcon",
  setup() {
    return () => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
