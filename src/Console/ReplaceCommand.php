...
namespace ReyPtr27\Jetstream\Console;
...
class ReplaceCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'reyptr27-jetstream:replace {stack : The development stack that should be replaced (livewire,inertia)}
